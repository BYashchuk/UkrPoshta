...
router.get('/auth', function (req, res, next) {
  ...
  //  let whatPageShow = req.cookies['installUkr'];
    let domein = process.env.appDomain;
//console.log(whatPageShow)
    ...
    if (securityPass && regex) {
      ...
      //  let accessTokenRequestUrlorders = 'https://' + shop + '/admin/orders';
    
            let accessTokenRequestUrlorders = 'https://' + domein;
       ...
       // let accessTokenRequestUrlorders = 'https://' + domein;
        ...
        request.post(accessTokenRequestUrl, { json: accessTokenPayload })
            .then((accessTokenResponse) => {
                ...
                res.redirect(accessTokenRequestUrlorders);
            })
            .catch((error) => {
...
router.get('/app', function (req, res, next) {
    ...
    res.render('app', { shop: shop, orderId: orderId, token: token });
});
...
router.get('/app/products', function (req, res, next) {
    ...
    let options = {
        ...
        json: true,
        headers: {
            'X-Shopify-Access-Token': req.cookies['accessToken'],
            'content-type': 'application/json'
        }
    };
